...
public class CreateOrderActivity extends AppCompatActivity {
    ...
    //строковая переменная, хранит название выбранного напитка
    private String drink;

    //должны формироваться из введенных пользователем строк, полученных из интента
    private String name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String additions = String.format(getString(R.string.drink_options), drink);
        ...
        drink = getString(R.string.choose_tea);
    ...
    public void onClickChangeDrink(View view) {
        ...
        if (id == R.id.radioButtonTea) {
            ...
            drink = getString(R.string.choose_coffee);
    ...
    public void onClickSendOrder(View view) {
        ...
        if (checkBoxMilk.isChecked()) {
            builderAdditions.append(getString(R.string.add_milk)).append(" ");
        }
        if (checkBoxSugar.isChecked()) {
            builderAdditions.append(getString(R.string.add_sugar)).append(" ");
        }
        if (checkBoxLemon.isChecked() && drink.equals(getString(R.string.choose_tea))) {
            builderAdditions.append(getString(R.string.add_lemon)).append(" ");
        }
        String optionOfDrink = "";
        if (drink.equals(getString(R.string.choose_tea))) {
